...
def _init_tracing():
    ...
    try:
        # Step 1: Set up TracerProvider with App Insights exporter
        ...
        if app_insights_cs:
            # Monkey-patch LogData if needed (same as pipeline.py)
            try:
        ...
        # Step 2: Enable azure-core tracing
        from azure.core.settings import settings
        from azure.core.tracing.ext.opentelemetry_span import OpenTelemetrySpan
        settings.tracing_implementation = OpenTelemetrySpan

        # Step 3: Instrument OpenAI responses.create() for gen_ai spans
