...
# Load .env from project root or agents/compliance/
load_dotenv()
...
# Output paths
DEFAULT_COMPLIANCE_OUTPUT_JSON = os.path.join(
    os.path.dirname(__file__), "reports", "compliance-output.json"
)
DEFAULT_COMPLIANCE_OUTPUT_MD = os.path.join(
    os.path.dirname(__file__), "reports", "compliance-report.md"
)
