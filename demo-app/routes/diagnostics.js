...
// Updated to use environment variable and restrict allowed algorithms
...
router.post('/verify-token', (req, res) => {
  ...
  try {
    // Fix: Use secret from environment and explicitly specify accepted algorithms
    ...
    res.json({
      ...
      secret_hint: '[REDACTED]',  // Removed secret leak
    });
  } catch (err) {
    res.status(401).json({
      valid: false,
