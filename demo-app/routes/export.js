...
router.post('/custom', (req, res) => {
  ...
  try {
    // SECURITY FIX: Avoid executing user-provided code by using Mustache for safe templating
    // This prevents arbitrary code execution (SSTI) by disallowing code execution in templates
