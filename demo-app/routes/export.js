...
router.post('/custom', (req, res) => {
  ...
  try {
    // FIX: Replaced unsafe new Function() with safe Mustache templating engine
    // This prevents arbitrary code execution by disallowing executable code in templates
