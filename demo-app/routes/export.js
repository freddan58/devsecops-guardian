...
router.post('/custom', (req, res) => {
  ...
  try {
    // FIX: Use mustache templating engine to safely render templates without code execution
    // This prevents arbitrary code execution by disallowing JS code in templates
