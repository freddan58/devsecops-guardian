...
router.post('/password-reset', (req, res) => {
  ...
  // FIX: Avoid user enumeration and token leakage
  // Always respond with a success message regardless of whether the email exists
  res.json({ message: 'If an account with that email exists, a reset link has been sent.' });

  // SECURITY COMMENT: Removed differentiating responses and token exposure to prevent
  // information disclosure and user enumeration attacks
});
