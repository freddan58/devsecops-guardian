...
const { Parser } = require('expr-eval'); // Add safe expression parser
...
router.post('/calculate-bonus', authenticateToken, (req, res) => {
  ...
  try {
    ...
    // FIX: Replace eval() with a safe expression parser to prevent arbitrary code execution
    const parser = new Parser();
    // Only allow references to 'salary' and basic math functions/operators
