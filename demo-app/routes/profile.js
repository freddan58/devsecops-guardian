...
router.post('/calculate-bonus', authenticateToken, (req, res) => {
  ...
  try {
    ...
    // FIX: Replaced unsafe eval with expr-eval parser
    // This securely evaluates mathematical expressions and prevents code execution
    const parser = new Parser();
    const expr = parser.parse(formula);
    // Only allow salary variable to be referenced
